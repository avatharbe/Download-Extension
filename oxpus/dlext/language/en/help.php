...
$lang = array_merge($lang, [
	...
	'HELP_DL_THUMB_CAT_MAX'				=> 'This option limits the maximum number of thumbnails per download. A minimum of one thumbnail is allowed.',
	'HELP_DL_THUMB_MAX_DIM_X'			=> 'This value limits the possible image width of uploaded thumbnails.<br>Thumbnails are displayed smaller, you can view the uploaded image in a popup window byu clicking on a thumbnail.<br><br>Enter 0 to disable thumbnails (not recommended, if the thumbnail file size is set).<br>Existing thumbnails are still displayed unless the thumbnail´s file size was not set to 0.',
	'HELP_DL_THUMB_MAX_DIM_X_MAX'		=> 'This value determines the displayed width of the thumbnails in pixels. Wider images will be displayed reduced to the specified size.',
	'HELP_DL_THUMB_MAX_DIM_Y'			=> 'This value limits the possible image height of uploaded thumbnails.<br>Thumbnails are displayed smaller, you can view the uploaded image in a popup window byu clicking on a thumbnail.<br><br>Enter 0 to disable thumbnails (not recommended, if the thumbnail file size is set).<br>Existing thumbnails are still displayed unless the thumbnail´s file size was not set to 0.',
	'HELP_DL_THUMB_MAX_DIM_Y_MAX'		=> 'This value determines the displayed height of the thumbnails in pixels. Taller images are displayed reduced to the specified size.',
